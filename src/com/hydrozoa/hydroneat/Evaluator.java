...
public abstract class Evaluator {
	...
	protected float averageGenomeFitness;
	...
	public void evaluateGeneration(Random r) {
		...
		for (int i = 0; i < genomes.size(); i++) {
			...
			averageGenomeFitness += fitnessGenome.fitness;
		}
		...
		averageGenomeFitness /= evaluatedGenomes.size();
	...
	public float getAverageGenomeFitness() {
		return averageGenomeFitness;
	}
